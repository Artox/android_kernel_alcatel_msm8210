...
enum {
	I2C_MINI_CORE           = 2U << 8,
	I2C_N_VAL               = 0xF,
	//add by junfeng.zhou.sz for modify i2c controller begin .  20140506
	I2C_CORE_CLK_ON_EN      = BIT(13),
	//add by junfeng.zhou.sz for modify i2c controller end .  
...
bool i2c_resume_completed = false;/*ADD---notice resume completed to advoid time out of I2C --- bug 630236---qifu.cheng---05/30/14 */
...
static void i2c_qup_pm_suspend(struct qup_i2c_dev *dev)
{
	...
	dev->pwr_state = MSM_I2C_PM_SUSPENDED;
		i2c_resume_completed = false;/*ADD---notice resume completed to advoid time out of I2C --- bug 630236---qifu.cheng---05/30/14 */
}
...
static void i2c_qup_pm_resume(struct qup_i2c_dev *dev)
{
	...
	i2c_resume_completed = true;/*ADD---notice resume completed to advoid time out of I2C --- bug 630236---qifu.cheng---05/30/14 */
}
//add by junfeng.zhou.sz for modify i2c controller end .  
...
//modify by junfeng.zhou.sz for modify i2c controller begin .  20140506
...
qup_i2c_remove(struct platform_device *pdev)
{
    ...
    //modify by junfeng.zhou.sz for modify i2c controller end .  
