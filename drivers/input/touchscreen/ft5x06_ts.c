...
{
	int ret;
/*ADD-BEGIN---fix the issue of i2c timeout---qifu.cheng---BUG 661727---05/04/14 */	
	struct ft5x06_ts_data *data = i2c_get_clientdata(client);
/*ADD-END---fix the issue of i2c timeout---qifu.cheng---BUG 661727---05/04/14*/
	if (writelen > 0) {
		struct i2c_msg msgs[] = {
			{
				 .addr = client->addr,
...
static int ft5x06_ts_resume(struct device *dev)
{
	...
	//data->suspended = false; /*Remove---fix the issue of i2c timeout---qifu.cheng---BUG 661727---05/04/14 */
