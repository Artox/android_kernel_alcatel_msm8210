...
//step 1: Calculate the actual backlight level
	...
	/*yongzhong.cheng:avoid white flash when powerdown rtc alarm
	bug ID:734742  miata3g,734745 lite.20140713,start
	*/
	if(alarm_boot_mode==1){
		bl_level =10;
	}
	/*yongzhong.cheng:avoid white flash when powerdown rtc alarm
	bug ID:734742  miata3g,734745 lite.20140713,end
	*/
...
#if 0 //del by yusen.ke.sz@tcl.com at 20140507 for Optimized code
