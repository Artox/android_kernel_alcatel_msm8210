...
/*modify by weicai.long@tcl.com for camera i2c suspend mode protection, 2014/5/4.*/
extern bool camera_in_suspend;

static int actuator_suspend(struct device *dev)
{
...
static int actuator_resume(struct device *dev)
{
    pr_err("camera_in_suspend:%d\n", camera_in_suspend);
...
static const struct dev_pm_ops actuator_pm_ops = {
    SET_SYSTEM_SLEEP_PM_OPS(actuator_suspend, actuator_resume)
};
...
/*end modify by weicai.long@tcl.com.*/
